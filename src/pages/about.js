...
const IndexPage = () => (
  <Layout>
    ...
    <p>For the better part of a decade I've worked in various aspects of web development from frontend design, to backend API development, to managing infrastructure and implementing automated processes.</p>
